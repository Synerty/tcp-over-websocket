...
if __name__ == "__main__":
    setupTestLogging("test_server_service")
    ...
    # Set config path to test_config/websocket_server
    configPath = (
        Path(__file__).parent.parent / "test_config" / "websocket_server"
    )
    ...
    logger.info("Starting TCP over WebSocket Test Server Service")
