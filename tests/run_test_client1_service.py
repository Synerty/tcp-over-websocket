...
if __name__ == "__main__":
    setupTestLogging("test_client1_service")
    ...
    # Set config path to test_config/websocket_client_1
    configPath = (
        Path(__file__).parent.parent / "test_config" / "websocket_client_1"
    )
    ...
    logger.info("Starting TCP over WebSocket Test Client 1 Service")
